...
const HomePage = () => {
  ...
  const featuredProjects = [
    ...
    },
    {
      ...
      title: 'Atlas Bar',
      category: 'Website',
      description: 'Stunning award-winning bar website for Singapore - luxury art deco design meets digital elegance.',
    ...
    },
    {
      ...
      category: 'Website',
      description: 'World class bar website - immersive storytelling, rich visuals and premium brand experience.',
            ...
            {[...Array(2)].map((_, repeat) => (
              <div key={repeat} style={{ display: 'flex', alignItems: 'center' }}>
                {[
                  ...
                  { name: 'Landbook',      logo: '/images/landbook-logo.png', style: { height: '150px', width: 'auto', maxWidth: '220px' } },
                  { name: 'James Edition', logo: '/images/jamesedition-logo.png' },
                  { name: 'Synthesia',     logo: '/images/synthesia-logo.png', style: { height: '150px', width: 'auto', maxWidth: '220px' } },
