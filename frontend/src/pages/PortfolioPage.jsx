...
const PortfolioPage = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      title: 'Atlas Bar',
      category: 'website',
      description: "Award-winning bar website for Singapore's iconic Atlas — luxury art deco design meets digital elegance.",
    ...
    },
    {
      ...
      category: 'website',
      description: "World's best bar website — immersive storytelling, rich visuals and a premium brand experience.",
